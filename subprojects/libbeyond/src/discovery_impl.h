...
#ifndef __BEYOND_INTERNAL_DISCOVERY_IMPL_H__
#define __BEYOND_INTERNAL_DISCOVERY_IMPL_H__
...
class Discovery::impl final : public Discovery {
...
#endif // __BEYOND_INTERNAL_DISCOVERY_IMPL_H__
