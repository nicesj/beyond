...
#
#  gRPC::grpc_custom - gRPC library
#  gRPC::grpc++_custom - gRPC C++ library
#  gRPC::grpc++_reflection_custom - gRPC C++ reflection library
#  gRPC::grpc_cpp_plugin_custom - C++ generator plugin for Protocol Buffers
#
...
function(GRPC_GENERATE_CPP SRCS HDRS DEST)
  ...
  foreach(FIL ${ARGN})
    ...
    add_custom_command(
      ...
      COMMAND protobuf::protoc_custom
      ARGS --grpc_out ${DEST} ${_protobuf_include_path} --plugin=protoc-gen-grpc=${GRPC_CPP_PLUGIN} ${ABS_FIL}
      DEPENDS ${ABS_FIL} protobuf::protoc_custom gRPC::grpc_cpp_plugin_custom
...
add_library(gRPC::grpc_custom UNKNOWN IMPORTED)
set_target_properties(gRPC::grpc_custom PROPERTIES
...
add_library(gRPC::grpc++_custom UNKNOWN IMPORTED)
set_target_properties(gRPC::grpc++_custom PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES gRPC::grpc_custom
...
add_library(gRPC::grpc++_reflection_custom UNKNOWN IMPORTED)
set_target_properties(gRPC::grpc++_reflection_custom PROPERTIES
    INTERFACE_INCLUDE_DIRECTORIES ${GRPC_INCLUDE_DIR}
    INTERFACE_LINK_LIBRARIES gRPC::grpc++_custom
...
add_executable(gRPC::grpc_cpp_plugin_custom IMPORTED)
set_target_properties(gRPC::grpc_cpp_plugin_custom PROPERTIES
